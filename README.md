...
4. Match each neuron's output to its DST term via the **Jacobi-Anger expansion**, solving for the second-layer weight: `w²_m = J₁⁻¹(|α_m| / 2)` with the sign absorbed into the output weight: `w_{out}_m = sign(α_m)`.
